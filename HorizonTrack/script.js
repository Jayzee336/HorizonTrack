...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function renderEmployees() {
    ...
    fetch('employees.json?t=' + Date.now())
      .then(response => response.json())
      .then(data => {
        const employees = Object.values(data.employees); // Convert object to array for easier iteration
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (removeEmployeeBtn && removeEmployeeModal) {
      ...
      const removeEmployeeCloseBtn = removeEmployeeModal.querySelector('.remove-project-close');
    ...
    // ... rest of existing DOMContentLoaded content ...
  });
});
